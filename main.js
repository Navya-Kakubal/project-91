...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("When up arrow is pressed, x =" + car1_x + " | y =" +car_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("When left arrow is pressed, x =" + car1_x + " | y =" +car_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_y = car1_y + 10;
		console.log("When right arrow is pressed, x =" + car1_x + " | y =" +car_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
